...
//    private static final String USERNAME = "tuser";
...
//        RequestSpecification request = RestAssured.given();  // Initialize request specification
//
//        request.header("Content-Type", "application/json"); // Set a header
//        response = request.body("{ \"userName\":\"" + USERNAME + "\", \"password\":\"" + PASSWORD + "\"}") // Serialize the credentials object to JSON
//                .post("/Account/v1/GenerateToken"); // sending POST request
//
